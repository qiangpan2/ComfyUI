...
uv run  main.py --listen --port 1245 --force-channels-last --bf16-vae --bf16-unet --gpu-only --verbose DEBUG 2>&1 | tee output.log

python main.py --listen --port 1245 --force-channels-last --bf16-vae --bf16-unet --gpu-only 2>&1 | tee output.log
